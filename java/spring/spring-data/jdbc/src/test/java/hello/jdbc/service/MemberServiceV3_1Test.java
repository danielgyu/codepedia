...
class MemberServiceV3_1Test {
    ...
    void before() {
        ...
        memberServiceV3_1 = new MemberServiceV3_1(manager, memberRepositoryV3);
    }
    ...
    void accountTransfer() throws SQLException {
        ...
        memberServiceV3_1.accountTransfer(MEM_A, MEM_B, 1000);
        //memberServiceV3_1.accountTransfer(MEM_A, MEM_EX, 1000);
    }
}